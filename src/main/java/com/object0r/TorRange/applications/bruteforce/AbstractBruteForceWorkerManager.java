...
abstract public class AbstractBruteForceWorkerManager extends ProxyWorkerManager
{
    Vector<BruteForcer> bruteForcers;

    public AbstractBruteForceWorkerManager(String iniFilename, Class workerClass)
    {
